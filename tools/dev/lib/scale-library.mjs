 ...
 *  - MATCH_* ids are the dev lab's base titles that its Seerr users have
 *    requested, so the bulk GET /request index matches them -> "requested".
...
// Canonical pairing: run this fixture against the REAL dev Seerr, whose requests
// are the MATCH ids below (not fake-seerr, which is a separate flaky-reproduction
