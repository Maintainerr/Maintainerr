...
describe('SeerrApiService', () => {
  ...
  beforeEach(async () => {
    const { unit } = await TestBed.solitary(SeerrApiService).compile();
    service = unit;
  });

  it('should ignore declined, completed, and completed-season requests when checking remaining seasons', async () => {
  ...
  it('should return undefined when Seerr data is unavailable', async () => {
