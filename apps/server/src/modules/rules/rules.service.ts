...
export class RulesService {
  ...
  async getRules(ruleGroupId: number): Promise<Rules[]> {
    try {
      ...
      this.warnWithDebug('Rules - Action failed', error);
      return undefined;
    }
  }
  ...
  async getRuleGroupByCollectionId(id: number) {
    try {
      ...
      this.logger.warn('Rules - Action failed', error);
      return undefined;
    }
  }
  ...
  async deleteRuleGroup(ruleGroupId: number): Promise<ReturnStatus> {
    try {
      ...
      this.warnWithDebug('Rulegroup deletion failed', error);
  ...
  async removeExclusion(id: number) {
    try {
      ...
      this.warnWithDebug(`Removing exclusion with id ${id} failed.`, error);
      return this.createReturnStatus(false, 'Failed');
    }
  }
  ...
  async getCommunityRules(): Promise<CommunityRule[] | ReturnStatus> {
    return await axios
      ...
      .catch((error) => {
        this.warnWithDebug('Loading community rules failed', error);
        return this.createReturnStatus(false, 'Failed');
      });
  }
  ...
  public async addToCommunityRules(rule: CommunityRule): Promise<ReturnStatus> {
    ...
    return axios
      ...
      .catch((error) => {
        this.warnWithDebug('Saving community rule failed', error);
  ...
  public async updateCommunityRuleKarma(
    ...
    return axios
      ...
      .catch((error) => {
        this.warnWithDebug('Updating community rule karma failed', error);
        return this.createReturnStatus(
          false,
