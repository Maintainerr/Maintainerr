...
export class AddLeftoverFolderCleanup1782847027675 implements MigrationInterface {
  name = 'AddLeftoverFolderCleanup1782847027675';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_settings" (
                ...
                "leftover_cleanup_enabled" boolean NOT NULL DEFAULT (0)
            )
        `);
    await queryRunner.query(`
