...
export class AddLeavingSoonMethodSetting1786912383502 implements MigrationInterface {
  name = 'AddLeavingSoonMethodSetting1786912383502';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_settings" (
                ...
                "leaving_soon_method" varchar NOT NULL DEFAULT ('collection')
            )
        `);
    await queryRunner.query(`
