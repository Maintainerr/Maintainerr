...
export class AddSportarrNetFallback1787771204339 implements MigrationInterface {
  name = 'AddSportarrNetFallback1787771204339';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_settings" (
                ...
                "sportarr_net_fallback" boolean NOT NULL DEFAULT (1)
            )
        `);
    await queryRunner.query(`
