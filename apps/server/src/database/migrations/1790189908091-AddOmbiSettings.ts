...
export class AddOmbiSettings1790189908091 implements MigrationInterface {
  name = 'AddOmbiSettings1790189908091';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_collection" (
                ...
                "keepInMaintainerrOnly" boolean NOT NULL DEFAULT (0),
                "forceOmbi" boolean NOT NULL DEFAULT (0),
